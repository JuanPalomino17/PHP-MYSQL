...
<div class="container">
    ...
    $consulta = "SELECT id, nombre, work_centers_id, entry_date FROM work_centers";
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class='btn-group'><button class='btn btn-primary' id="btnNuevo" type="button" data-toggle="modal">Nuevo</button><button class='btn btn-danger' id="btnDescargarExcel">Reporte</button></div>
            </div>
        </div>
    </div>
    <br>
                ...
                <form id="formPersonas">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="cedula" maxlength="10" required>
                        </div>
                        <div class="form-group">
